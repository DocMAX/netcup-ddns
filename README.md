...
This version of the script uses OpenWRT's local ubus API to retrieve WAN IP addresses directly from the router's network interfaces, eliminating the need for external IP lookup services.
